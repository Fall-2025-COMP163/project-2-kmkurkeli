...
AI Usage: AI helped with test setup and implementing Mage.fireball()
"""
...
class Character:
    ...
    def take_damage(self, damage):
        """Reduce health by damage but not below zero"""
...
if __name__ == "__main__":
    ...
    warrior = Warrior("Kurkeli the Brave")
    mage = Mage("Elaris the Arcane")
    rogue = Rogue("Nyx the Shadow")
    ...
    target1 = Character("Training Dummy 1", 60, 0, 0)
    target2 = Character("Training Dummy 2", 60, 0, 0)
    target3 = Character("Training Dummy 3", 60, 0, 0)
